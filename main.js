$(document).ready(function () { //checks if html is fully loaded
	...
	$('.my-button').on("click", function (e) { //when a button with class .my-button is clicked
		...
		var my123 = $(this), // gather the info related to "this" button that was clicked and store in a variable call myInfo
			myUrl = my123.data('image'); //from myInfo, grab the URL stored in data-image attribut and store in myUrl
